# DEPRECATED — Boilerplater v0 Skill\n\n**Renamed in v1.0 to:** `compliance_orchestrator` (see `skills/compliance/audit.md`)\n\n**Alias:** `skills/jreng_compliance/SKILL.md` symlinks to the new orchestrator.\n\n**Removal:** v2.0\n\n---\n\n---
